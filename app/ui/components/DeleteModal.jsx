const DeleteModal = ({onDelete , isModalOpen, setIsModalOpen}) => {
    return ( 
        <dialog open={isModalOpen} onClose={() => setIsModalOpen(false)} className={`${!isModalOpen?"hidden":"w-full flex justify-center items-center fixed z-50 bg-transparent font-DanaDemiBold md:inset-0"}`}>
            <div className="relative p-4 w-full max-w-md h-screen md:h-auto">
                ...
                <p className="mb-4 text-gray-500 dark:text-gray-300">مطمئن هستی می خوای این مورد پاک بشه؟</p>
                <div className=" flex justify-center items-center gap-x-4">
                    ...
                    <button onClick={onDelete} type="submit" className="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
                        آره بابا پاکش کن
                    </button>
                </div>
                </div>
